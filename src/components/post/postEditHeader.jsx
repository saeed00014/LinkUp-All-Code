...
const PostEditHeader = ({setMakePost}) => {
  return (
    <header className="flex justify-between items-center w-full py-3 pr-2">
      <span>{postEdit.postEdit}</span>
      <button onClick={() => setMakePost('')} className='relative flex items-center justify-center font-normal min-w-[40px] min-h-[40px] rounded-full hover:bg-gray-200 dark:hover:bg-gray-600'>
