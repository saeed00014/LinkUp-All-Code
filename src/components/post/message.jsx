...
import MessageDelete from "@/app/chats/inbox/messageDelete"
import MessageEdit from "@/app/chats/inbox/messageEdit"
    ...
    return (
      <li className="relative flex items-end min-w-full gap-2">
        ...
        <div className="w-full">
          ...
          <div className={`flex w-full text-[.8rem] ${message.id == chooseMessage.id ? "bg-gray-700" : ""} rounded-r-[1rem] z-20`}>
            <span 
              onClick={handleClick} 
