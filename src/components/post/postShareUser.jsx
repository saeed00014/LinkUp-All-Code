...
const PostShareUser = ({searchResult}) => {
  return (
    <div className="absolute top-0 flex flex-col w-full rounded-[.3rem] h-screen max-h-[33.5rem] pt-[3.5rem] bg-white dark:bg-gray-800 overflow-y-scroll z-30">
      {searchResult.map((user) => {
        return (
          <div className="group relative flex items-center justify-start w-full cursor-default">
