...
const PostMake = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-[550px] pt-3 pb-2 px-4 rounded-[.8rem] bg-white dark:bg-gray-800">
      <div className="flex items-center gap-4 pb-3 mb-1 border-b-2 dark:border-gray-600">
        ...
        <span onClick={() => setMakePost("text")} className="flex items-center justify-start w-full h-fit py-2 pr-4 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200
        dark:hover:bg-gray-600 duration-100 cursor-pointer">
