...
const MoreLink = () => {
  ...
  return (
    <li className='group relative w-full xl:py-1'>
      ...
      >
        <div className={`group flex items-center w-full xl:py-3 xl:pr-3 xl:pl-6 pr-3 pl-3 py-3 rounded-[.6rem] gap-5 group-hover:bg-gray-200 dark:group-hover:bg-gray-700 ${isActive ? "bg-gray-200 dark:bg-gray-700" : ""} duration-100`}>
