...
const ProfileHeader = () => {
  ...
  return (
    <div className="sticky flex items-center w-full h-[200px] z-40">
      ...
      <div className="absolute right-0 flex flex-col justify-between h-full w-[17rem] pt-1 pb-3 px-4 dark:bg-gray-800 bg-white z-10 gap-0">
        ...
        <span className="text-[1.2rem]">{user.username}</span>
        <span>{user.job}</span>
        <span>{user.bio}</span>
        {user.link && (
          <a
        ...
        <div className="flex w-full gap-5">
          <div className="flex justify-between w-full h-[1.8rem]">
            ...
            <span className="flex justify-center w-full">{follower}</span>
          </div>
          <div className="flex justify-between w-full h-[1.8rem]">
            <span className="min-w-[70px]">{profile.followers}</span>
            <span className="flex justify-center w-full">{following}</span>
          </div>
        </div>
        {isLoginUser ? (
      ...
      <div className="absolute right-[16.5rem] top-[4.75rem] flex h-[130px] w-[130px] z-10 rounded-full overflow-hidden">
        <Image
